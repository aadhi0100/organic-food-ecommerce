...
export const FileStorage = {
  ...
  users: {
    save: (user: User) => {
      try {
        ...
        console.log('FileStorage.users.save skipped')
      }
    },
  ...
  carts: {
    save: (userId: string, items: CartItem[]) => {
      try {
        ...
        console.log('FileStorage.carts.save skipped')
      }
    },
    ...
    clear: (userId: string) => {
      try {
        ...
        console.log('FileStorage.carts.clear skipped')
      }
    }
  },
  ...
  orders: {
    save: (order: Order) => {
      try {
        ...
        console.log('FileStorage.orders.save skipped')
      }
    },
  ...
  products: {
    saveAll: (products: Product[]) => {
      try {
        ...
        console.log('FileStorage.products.saveAll skipped')
      }
    },
  ...
  init: () => {
    try {
      ...
      console.log('FileStorage init skipped (serverless environment)')
    }
  }
}
